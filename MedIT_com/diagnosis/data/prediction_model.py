...
training_data = os.path.join(THIS_FOLDER, 'training_data.csv')
testing_data = os.path.join(THIS_FOLDER, 'testing_data.csv')
...
def NaiveBayes(s1, s2, s3, s4, s5):
    ...
    if (h=='yes'):
        ...
        return "No diagnosis could be made. Please try again using different combination of symptoms."